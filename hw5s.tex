...
$\tup{V, A, \iota}$, where $\iota$ is the map $A \to V \times V$ that
...
least one chip when we fire $w$ (unless the cycle $c$ has length $1$,
in which case this vertex is $v$ itself, but in that case it at least
regains the chip that it fired);
thus, the cycle $c$ remains non-void in this case.
...
\bibitem[Galvin17]{Galvin}David Galvin, \textit{Basic discrete mathematics}, 13
December 2017.\newline
