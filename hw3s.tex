...
Then, $G - e$ will denote the multigraph obtained from $G$ by
removing the edge $e$.
...
\item   Let us now consider Case 2.
        ...
        \qquad \left(\text{by \eqref{pf.thm.hw3.uv-pc.c2.1}}\right) \\
...
&= \tup{\text{the length of the path } \tup{x_0, x_1, \ldots, x_{i-1}}
       } \\
&\qquad \left(\text{since } \tup{x_0, x_1, \ldots, x_{i-1}}
