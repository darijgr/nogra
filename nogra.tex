...
\begin{definition} \label{def.simple.sg}
...
Definition~\ref{def.simple.sg} can be rewritten as ``$E$ is a set of
$2$-element subsets of $V$'' (since $\powset[2]{V}$ is the set of all
$2$-element subsets of $V$). Thus, a simple graph is a pair consisting
of a finite set $V$, and a set of $2$-element subsets of $V$.
For example,
...
\begin{conclusion}
\textbf{(a)}
Our Definition~\ref{def.simple.sg} differs from the definition of a
...
\begin{definition} \label{def.simple.VE}
