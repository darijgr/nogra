...
\end{align*}
(This graph can be drawn in such a way as to look like a regular
hexagon with its three longest diagonals.)
...
the three vertices $a = 1$, $b = 5$ and $c = 6$ work.
...
\begin{todo}
Picture of a path graph, maybe with the isomorphism.
\end{todo}
...
\begin{todo}
Picture of a cycle graph, and visual explanation of reflection and
rotations.
\end{todo}
...
We refer to \cite[\S 10.10]{LeLeMe16}, or \cite[Chapter 11]{Hammac16}
...
fundamentals of algebra}, 15 February 2017.
...
revised Monday 20th February, 2017,
