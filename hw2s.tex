...
with respect to the multidigraph $D$)\ \ \ \ \footnote{\textit{Proof.}
...
$r \in \set{0, 1, \ldots, k^n-1}$ such that $a = p_r$.
...
So let $E$ and $F$ be two tournaments with vertex set $V$, and
